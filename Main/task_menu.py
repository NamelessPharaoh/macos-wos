...
TASKS = [
    ...
    TaskSpec("arena", "Arena", "Enter the arena routine.", lambda pid: arena(pid), gate="arena_of_glory"),
    TaskSpec("chief_order", "Chief Order", "Activate chief order tasks.", lambda _player_id: activate_chief_order(), gate="chiefs_house"),
    TaskSpec("pet_treasure", "Ally Treasure", "Collect ally treasure.", lambda pid: collect_ally_treasure(pid), gate="beast_cage"),
    TaskSpec("pet_exploration", "Pet Exploration", "Start pet exploration.", lambda pid: start_pet_exploration(pid), gate="beast_cage"),
    TaskSpec("labyrinth", "Labyrinth", "Run the labyrinth routine.", lambda pid: labyrinth(pid), gate="labyrinth"),
